/**
 * Some extensions to native types needed by the template system.
 */ 

/**
 * When defining a template tag, call this method 
 * on the tag function to mark it as a "closed tag". 
 *  
 * Closed tags are tags that that have an opening and 
 * a closing statement. For example: 
 *  
 * {{{ 
 *  {% for i in items %} 
 *    .... 
 ...
 * }}} 
 *  
 * When a tag is marked as a closed tag, it also means 
 * that the tag can have "children", which are other tags 
 * and HTML tokens between the opening and closing statements.
 */
Function.prototype.tagExpectsClosing = function(){
  this.expectsClosing = true;
  return this;
}

/**
 * Use this to override the default render function of a tag.
 */
Function.prototype.tagRender = function(fun){
  this.renderFunction = fun;
  return this;
}

/**
 * Use this to override the default compile function of a tag.
 */
Function.prototype.tagCompile = function(fun){
  this.compileFunction = fun;
  return this;
}
